...
void Initialize() {
    ...
    Vector4f a = Vector4f(0,0,5,1);
    Vector4f a1 = Vector4f(1.0,0,5,1);
    Vector4f b0 = Vector4f(1.5,0,5,1);
    Vector4f b = Vector4f(2,0,5,1);
    Vector4f c = Vector4f(3,0,5,1);
    Vector4f e = Vector4f(4,0,5,1);
    ...
    Vector4f a2 = Vector4f(-1,0,0,1);
    Vector4f a3 = Vector4f(-2.0,0,0,1);
    Vector4f b2 = Vector4f(-2.5,0,0,1);
    Vector4f b3 = Vector4f(-3,0,0,1);
    Vector4f c2 = Vector4f(-4,0,0,1);
    Vector4f e2 = Vector4f(-5,0,0,1);
    Vector4f d2 = Vector4f(-1,0,0,0);

    Link z0 = Link(a2,d2,1);
    arm1.push_back(z0);
    Link z00 = Link(a3, d2, 0.5);
    arm1.push_back(z00);
    Link z1 = Link(b2,d2,0.5);
    arm1.push_back(z1);
